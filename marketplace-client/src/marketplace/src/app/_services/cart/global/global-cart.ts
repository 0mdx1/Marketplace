...
export class GlobalCart implements Cart {
  ...
  constructor(
    ...
    @Inject(SendRequestStrategyService)
    private sendRequestStrategy: SendRequestStrategy
  ) {}
  ...
  addItem(item: CartItem): void {
    ...
    if (this.sendRequestStrategy.allowedToSendRequests()) {
      this.subs.push(
        this.httpService.putShoppingCartItem(item).subscribe({
          error: (e) => {
  ...
  empty(): void {
    ...
    if (this.sendRequestStrategy.allowedToSendRequests()) {
      this.subs.push(
        this.httpService.deleteShoppingCart().subscribe({
          error: (e) => {
            let apiError = e.error as ApiError;
            if (apiError) {
              this.alertService.addAlert(apiError.message, AlertType.Danger);
  ...
  removeItem(item: CartItem): void {
    ...
    if (this.sendRequestStrategy.allowedToSendRequests()) {
      this.subs.push(
        this.httpService.deleteShoppingCartItem(item).subscribe({
          error: (e) => {
            let apiError = e.error as ApiError;
            if (apiError) {
              this.alertService.addAlert(apiError.message, AlertType.Danger);
  ...
  setItems(items: CartItem[]): void {
    ...
    if (this.sendRequestStrategy.allowedToSendRequests()) {
      this.subs.push(
        this.httpService.putShoppingCart(items).subscribe({
          error: (e) => {
            let apiError = e.error as ApiError;
            if (apiError) {
              this.alertService.addAlert(apiError.message, AlertType.Danger);
  ...
  updateItem(item: CartItem): void {
    ...
    if (this.sendRequestStrategy.allowedToSendRequests()) {
      this.subs.push(
        this.httpService.patchShoppingCartItem(item).subscribe({
          error: (e) => {
            let apiError = e.error as ApiError;
            if (apiError) {
              this.alertService.addAlert(apiError.message, AlertType.Danger);
